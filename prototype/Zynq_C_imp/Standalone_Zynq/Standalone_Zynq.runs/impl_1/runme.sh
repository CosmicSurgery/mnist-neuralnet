...
HD_PWD='C:/Users/miles/Projects/fpga/mnist_neuralnet/prototype/Zynq_C_imp/Standalone_Zynq/Standalone_Zynq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_only_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq_only_wrapper.tcl -notrace
