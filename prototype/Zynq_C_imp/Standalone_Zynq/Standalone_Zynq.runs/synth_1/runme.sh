...
HD_PWD='C:/Users/miles/Projects/fpga/mnist_neuralnet/prototype/Zynq_C_imp/Standalone_Zynq/Standalone_Zynq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_only_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_only_wrapper.tcl
