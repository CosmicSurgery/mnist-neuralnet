...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/milestone 2/projects/cluster/cluster.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cluster.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cluster.tcl
