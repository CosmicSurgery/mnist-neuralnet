...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/5_18_dmagithub/Vivado/zedboard_axi_dma/zedboard_axi_dma.runs/zedboard_axi_dma_auto_us_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zedboard_axi_dma_auto_us_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zedboard_axi_dma_auto_us_2.tcl
