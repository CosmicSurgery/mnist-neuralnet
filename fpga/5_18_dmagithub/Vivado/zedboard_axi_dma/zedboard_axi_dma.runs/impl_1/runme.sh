...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/5_18_dmagithub/Vivado/zedboard_axi_dma/zedboard_axi_dma.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zedboard_axi_dma_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zedboard_axi_dma_wrapper.tcl -notrace
