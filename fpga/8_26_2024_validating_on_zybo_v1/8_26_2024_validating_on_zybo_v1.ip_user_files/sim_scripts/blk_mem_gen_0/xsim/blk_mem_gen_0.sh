...
#
# Generated by Vivado on Tue Sep 17 16:55:20 -0700 2024
...
simulate()
{
  xsim blk_mem_gen_0 -key {Behavioral:sim_1:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/layer_0.protoinst" -protoinst "protoinst_files/DP_PL_PS_BRAM.protoinst" -protoinst "protoinst_files/DP_Weight_Memory.protoinst" -log simulate.log
}
