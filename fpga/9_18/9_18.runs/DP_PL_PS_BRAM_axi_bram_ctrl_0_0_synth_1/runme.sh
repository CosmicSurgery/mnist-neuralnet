...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/9_18/9_18.runs/DP_PL_PS_BRAM_axi_bram_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DP_PL_PS_BRAM_axi_bram_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DP_PL_PS_BRAM_axi_bram_ctrl_0_0.tcl
