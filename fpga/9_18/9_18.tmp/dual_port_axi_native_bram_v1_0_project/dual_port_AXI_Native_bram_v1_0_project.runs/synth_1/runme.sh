...
HD_PWD='c:/git_repos/mnist_neuralnet/fpga/9_18/9_18.tmp/dual_port_axi_native_bram_v1_0_project/dual_port_AXI_Native_bram_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dual_port_AXI_Native_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dual_port_AXI_Native_bram.tcl
