...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/milestone2/projects/DMA_test/DMA_test.runs/design_2_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_blk_mem_gen_0_0.tcl
