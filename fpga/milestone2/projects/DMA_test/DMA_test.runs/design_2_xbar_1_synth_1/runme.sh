...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/milestone2/projects/DMA_test/DMA_test.runs/design_2_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_xbar_1.tcl
