...
//	status = XAxiDma_SimpleTransfer(&dma_ctl, XPAR_AXI_BRAM_CTRL_0_S_AXI_BASEADDR, DMA_TRANSFER_SIZE*4, XAXIDMA_DEVICE_TO_DMA);
//
...
//	for (u32 i=0; i<DMA_TRANSFER_SIZE; i++) {
//		xil_printf("%u ", Xil_In32(XPAR_AXI_BRAM_CTRL_0_S_AXI_BASEADDR + (i*4)));
//	}
//
//	return XST_SUCCESS;
