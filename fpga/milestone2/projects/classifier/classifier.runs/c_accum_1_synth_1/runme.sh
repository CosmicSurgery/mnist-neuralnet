...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/milestone2/projects/classifier/classifier.runs/c_accum_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_accum_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_accum_1.tcl
