...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/milestone 2/projects/cluster/cluster.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cluster.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cluster.tcl -notrace
