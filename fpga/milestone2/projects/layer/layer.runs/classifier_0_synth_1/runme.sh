...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/milestone2/projects/layer/layer.runs/classifier_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log classifier_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source classifier_0.tcl
