...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/milestone2/projects/DP_bram/DP_bram.runs/axi_bram_block_DP_bram_16_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_bram_block_DP_bram_16_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_bram_block_DP_bram_16_0.tcl
