...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/milestone2/projects/MemoryManager/MemoryManager.runs/weight_memory_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log weight_memory_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source weight_memory_0.tcl
