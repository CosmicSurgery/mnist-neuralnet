...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/milestone2/projects/MemoryManager/MemoryManager.runs/DP_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DP_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DP_bram_0.tcl
