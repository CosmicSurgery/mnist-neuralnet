...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/5_20_forwardpass/5_20_forwardpass.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log layer_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source layer_0.tcl
