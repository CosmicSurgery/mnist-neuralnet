...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/projects/10_9/10_9.runs/design_3_hardmax_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_3_hardmax_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_3_hardmax_0_0.tcl
