...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/projects/10_9/10_9.runs/design_1_perceptron_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_perceptron_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_perceptron_0_1.tcl
