...
--               C:/git_repos/mnist_neuralnet/fpga/projects/10_9/10_9.srcs/sources_1/bd/design_3/ip/design_3_axi_timebase_wdt_0_0/design_3_axi_timebase_wdt_0_0_sim_netlist.vhdl
...
entity design_3_axi_timebase_wdt_0_0_cdc_sync is
  port (
  ...
  attribute ORIG_REF_NAME of design_3_axi_timebase_wdt_0_0_cdc_sync : entity is "cdc_sync";
end design_3_axi_timebase_wdt_0_0_cdc_sync;

architecture STRUCTURE of design_3_axi_timebase_wdt_0_0_cdc_sync is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_3_axi_timebase_wdt_0_0_pselect_f is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_3_axi_timebase_wdt_0_0_pselect_f : entity is "pselect_f";
end design_3_axi_timebase_wdt_0_0_pselect_f;

architecture STRUCTURE of design_3_axi_timebase_wdt_0_0_pselect_f is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \design_3_axi_timebase_wdt_0_0_pselect_f__parameterized1\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \design_3_axi_timebase_wdt_0_0_pselect_f__parameterized1\ : entity is "pselect_f";
end \design_3_axi_timebase_wdt_0_0_pselect_f__parameterized1\;

architecture STRUCTURE of \design_3_axi_timebase_wdt_0_0_pselect_f__parameterized1\ is
begin
CS: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_3_axi_timebase_wdt_0_0_address_decoder is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_3_axi_timebase_wdt_0_0_address_decoder : entity is "address_decoder";
end design_3_axi_timebase_wdt_0_0_address_decoder;

architecture STRUCTURE of design_3_axi_timebase_wdt_0_0_address_decoder is
  ...
  attribute SOFT_HLUTNM of \MEM_DECODE_GEN[0].cs_out_i[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of eWDT1_Reg_i_1 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of eWDT2_Reg_i_1 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \iTimebase_count[0]_i_4\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \s_axi_rdata_i[4]_i_3\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of wdt_State_Reg_i_2 : label is "soft_lutpair2";
begin
...
\MEM_DECODE_GEN[0].PER_CE_GEN[0].MULTIPLE_CES_THIS_CS_GEN.CE_I\: entity work.design_3_axi_timebase_wdt_0_0_pselect_f
     port map (
...
\MEM_DECODE_GEN[0].PER_CE_GEN[2].MULTIPLE_CES_THIS_CS_GEN.CE_I\: entity work.\design_3_axi_timebase_wdt_0_0_pselect_f__parameterized1\
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_3_axi_timebase_wdt_0_0_timebase_wdt_core is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_3_axi_timebase_wdt_0_0_timebase_wdt_core : entity is "timebase_wdt_core";
end design_3_axi_timebase_wdt_0_0_timebase_wdt_core;

architecture STRUCTURE of design_3_axi_timebase_wdt_0_0_timebase_wdt_core is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of Current_State_i_1 : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \g0_b2__1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of wdt_Bitin_1d_i_2 : label is "soft_lutpair11";
begin
...
INPUT_DOUBLE_REGS3: entity work.design_3_axi_timebase_wdt_0_0_cdc_sync
     port map (
      freeze => freeze,
      \p_0_in__0\ => \p_0_in__0\,
...
\iTimebase_count_reg[0]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 1) => \^itimebase_count_reg\(3 downto 1),
...
\iTimebase_count_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^itimebase_count_reg\(15 downto 12)
    );
...
\iTimebase_count_reg[16]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^itimebase_count_reg\(19 downto 16)
    );
...
\iTimebase_count_reg[20]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^itimebase_count_reg\(23 downto 20)
    );
...
\iTimebase_count_reg[24]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^itimebase_count_reg\(27 downto 24)
    );
...
\iTimebase_count_reg[28]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \^p_0_in\,
      S(2 downto 0) => \^itimebase_count_reg\(30 downto 28)
    );
...
\iTimebase_count_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^itimebase_count_reg\(7 downto 4)
    );
...
\iTimebase_count_reg[8]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^itimebase_count_reg\(11 downto 8)
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_3_axi_timebase_wdt_0_0_slave_attachment is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_3_axi_timebase_wdt_0_0_slave_attachment : entity is "slave_attachment";
end design_3_axi_timebase_wdt_0_0_slave_attachment;

architecture STRUCTURE of design_3_axi_timebase_wdt_0_0_slave_attachment is
  ...
  attribute SOFT_HLUTNM of \bus2ip_addr_i[3]_i_3\ : label is "soft_lutpair7";
...
I_DECODER: entity work.design_3_axi_timebase_wdt_0_0_address_decoder
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_3_axi_timebase_wdt_0_0_axi_lite_ipif is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_3_axi_timebase_wdt_0_0_axi_lite_ipif : entity is "axi_lite_ipif";
end design_3_axi_timebase_wdt_0_0_axi_lite_ipif;

architecture STRUCTURE of design_3_axi_timebase_wdt_0_0_axi_lite_ipif is
  signal s_axi_wdata_0_sn_1 : STD_LOGIC;
  signal s_axi_wdata_1_sn_1 : STD_LOGIC;
begin
  s_axi_wdata_0_sp_1 <= s_axi_wdata_0_sn_1;
  s_axi_wdata_1_sp_1 <= s_axi_wdata_1_sn_1;
I_SLAVE_ATTACHMENT: entity work.design_3_axi_timebase_wdt_0_0_slave_attachment
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_3_axi_timebase_wdt_0_0_axi_timebase_wdt is
  port (
    is_write_reg : out STD_LOGIC;
    wdt_reset : out STD_LOGIC;
    timebase_interrupt : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_3_axi_timebase_wdt_0_0_axi_timebase_wdt : entity is "axi_timebase_wdt";
end design_3_axi_timebase_wdt_0_0_axi_timebase_wdt;

architecture STRUCTURE of design_3_axi_timebase_wdt_0_0_axi_timebase_wdt is
...
AXI4_LITE_I: entity work.design_3_axi_timebase_wdt_0_0_axi_lite_ipif
     port map (
...
TIMEBASE_WDT_CORE_I: entity work.design_3_axi_timebase_wdt_0_0_timebase_wdt_core
     port map (
      Bus_RNW_reg => \I_SLAVE_ATTACHMENT/I_DECODER/Bus_RNW_reg\,
      \GEN_BKEND_CE_REGISTERS[0].ce_out_i_reg\ => \I_SLAVE_ATTACHMENT/I_DECODER/GEN_BKEND_CE_REGISTERS[0].ce_out_i_reg\,
      Q(4 downto 0) => timer_width(4 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_3_axi_timebase_wdt_0_0_axi_timebase_wdt_top is
  port (
  ...
  attribute C_ENABLE_WINDOW_WDT of design_3_axi_timebase_wdt_0_0_axi_timebase_wdt_top : entity is 0;
  attribute C_FAMILY : string;
  attribute C_FAMILY of design_3_axi_timebase_wdt_0_0_axi_timebase_wdt_top : entity is "zynq";
  attribute C_MAX_COUNT_WIDTH : integer;
  attribute C_MAX_COUNT_WIDTH of design_3_axi_timebase_wdt_0_0_axi_timebase_wdt_top : entity is 32;
  attribute C_SST_COUNT_WIDTH : integer;
  attribute C_SST_COUNT_WIDTH of design_3_axi_timebase_wdt_0_0_axi_timebase_wdt_top : entity is 8;
  attribute C_S_AXI_ADDR_WIDTH : integer;
  attribute C_S_AXI_ADDR_WIDTH of design_3_axi_timebase_wdt_0_0_axi_timebase_wdt_top : entity is 4;
  attribute C_S_AXI_DATA_WIDTH : integer;
  attribute C_S_AXI_DATA_WIDTH of design_3_axi_timebase_wdt_0_0_axi_timebase_wdt_top : entity is 32;
  attribute C_WDT_ENABLE_ONCE : integer;
  attribute C_WDT_ENABLE_ONCE of design_3_axi_timebase_wdt_0_0_axi_timebase_wdt_top : entity is 1;
  attribute C_WDT_INTERVAL : integer;
  attribute C_WDT_INTERVAL of design_3_axi_timebase_wdt_0_0_axi_timebase_wdt_top : entity is 30;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_3_axi_timebase_wdt_0_0_axi_timebase_wdt_top : entity is "axi_timebase_wdt_top";
end design_3_axi_timebase_wdt_0_0_axi_timebase_wdt_top;

architecture STRUCTURE of design_3_axi_timebase_wdt_0_0_axi_timebase_wdt_top is
...
\LEGACY_WDT.axi_timebase_wdt_i\: entity work.design_3_axi_timebase_wdt_0_0_axi_timebase_wdt
     port map (
      freeze => freeze,
...
entity design_3_axi_timebase_wdt_0_0 is
  ...
  attribute NotValidForBitStream of design_3_axi_timebase_wdt_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_3_axi_timebase_wdt_0_0 : entity is "design_3_axi_timebase_wdt_0_0,axi_timebase_wdt_top,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_3_axi_timebase_wdt_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_3_axi_timebase_wdt_0_0 : entity is "axi_timebase_wdt_top,Vivado 2019.2";
end design_3_axi_timebase_wdt_0_0;

architecture STRUCTURE of design_3_axi_timebase_wdt_0_0 is
  ...
  attribute x_interface_parameter of s_axi_aclk : signal is "XIL_INTERFACENAME S_AXI_ACLK, ASSOCIATED_BUSIF S_AXI, ASSOCIATED_RESET s_axi_aresetn:wdt_reset, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN design_3_s_axi_aclk_0, INSERT_VIP 0";
...
begin
U0: entity work.design_3_axi_timebase_wdt_0_0_axi_timebase_wdt_top
     port map (
      freeze => freeze,
      s_axi_aclk => s_axi_aclk,
