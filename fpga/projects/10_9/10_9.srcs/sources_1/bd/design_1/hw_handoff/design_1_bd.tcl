...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net axi4_lite_final_outp_0_a_tvalid [get_bd_pins axi4_lite_final_outp_0/a_tvalid] [get_bd_pins hardmax_0/a_tValid] [get_bd_pins ila_1/probe2]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins image_loader_module_0/start] [get_bd_pins perceptron_0/start] [get_bd_pins perceptron_1/start] [get_bd_pins perceptron_2/start] [get_bd_pins perceptron_3/start]
  connect_bd_net -net hardmax_0_z_tValid [get_bd_pins axi_gpio_1/gpio2_io_i] [get_bd_pins hardmax_0/z_tValid]
  connect_bd_net -net hardmax_0_z_tdata [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins hardmax_0/z_tdata]
  ...
  connect_bd_net -net perceptron_1_a_tdata [get_bd_pins axi4_lite_final_outp_0/a_2_1] [get_bd_pins ila_1/probe0] [get_bd_pins perceptron_1/a_tdata]
  connect_bd_net -net perceptron_1_done [get_bd_pins axi4_lite_final_outp_0/a0done] [get_bd_pins axi4_lite_final_outp_0/a1done] [get_bd_pins axi4_lite_final_outp_0/a2done] [get_bd_pins axi4_lite_final_outp_0/a3done] [get_bd_pins axi4_lite_final_outp_0/a4done] [get_bd_pins axi4_lite_final_outp_0/a5done] [get_bd_pins axi4_lite_final_outp_0/a6done] [get_bd_pins axi4_lite_final_outp_0/a7done] [get_bd_pins axi4_lite_final_outp_0/a8done] [get_bd_pins axi4_lite_final_outp_0/a9done] [get_bd_pins ila_1/probe1] [get_bd_pins perceptron_1/done]
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_pins axi4_lite_final_outp_0/a_2_0] [get_bd_pins axi4_lite_final_outp_0/a_2_2] [get_bd_pins axi4_lite_final_outp_0/a_2_3] [get_bd_pins axi4_lite_final_outp_0/a_2_4] [get_bd_pins axi4_lite_final_outp_0/a_2_5] [get_bd_pins axi4_lite_final_outp_0/a_2_6] [get_bd_pins axi4_lite_final_outp_0/a_2_7] [get_bd_pins axi4_lite_final_outp_0/a_2_8] [get_bd_pins axi4_lite_final_outp_0/a_2_9] [get_bd_pins xlconstant_1/dout]
  ...
  assign_bd_address -offset 0x42600000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_timebase_wdt_0/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x43C20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs perceptron_2/s_axi/reg0] -force
  assign_bd_address -offset 0x43C30000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs perceptron_3/s_axi/reg0] -force
