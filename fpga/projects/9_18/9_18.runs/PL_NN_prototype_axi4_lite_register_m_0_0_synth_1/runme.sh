...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/projects/9_18/9_18.runs/PL_NN_prototype_axi4_lite_register_m_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PL_NN_prototype_axi4_lite_register_m_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PL_NN_prototype_axi4_lite_register_m_0_0.tcl
