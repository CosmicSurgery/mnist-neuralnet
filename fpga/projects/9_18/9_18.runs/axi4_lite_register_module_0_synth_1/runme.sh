...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/projects/9_18/9_18.runs/axi4_lite_register_module_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi4_lite_register_module_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi4_lite_register_module_0.tcl
