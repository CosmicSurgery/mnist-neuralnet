...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/projects/9_18/9_18.runs/PL_NN_axis_broadcaster_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PL_NN_axis_broadcaster_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PL_NN_axis_broadcaster_0_1.tcl
