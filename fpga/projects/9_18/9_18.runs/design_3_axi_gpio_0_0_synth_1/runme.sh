...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/projects/9_18/9_18.runs/design_3_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_3_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_3_axi_gpio_0_0.tcl
