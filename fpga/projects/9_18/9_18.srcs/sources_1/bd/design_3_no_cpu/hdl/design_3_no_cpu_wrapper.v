...
//Date        : Wed Oct  9 14:45:55 2024
//Host        : DESKTOP-L93G0Q0 running 64-bit major release  (build 9200)
//Command     : generate_target design_3_no_cpu_wrapper.bd
//Design      : design_3_no_cpu_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module design_3_no_cpu_wrapper
   (a_tdata_0,
    aclk_0,
    done_0,
    s_axi_aresetn_0,
  ...
  design_3_no_cpu design_3_no_cpu_i
       (.a_tdata_0(a_tdata_0),
        .aclk_0(aclk_0),
        .done_0(done_0),
