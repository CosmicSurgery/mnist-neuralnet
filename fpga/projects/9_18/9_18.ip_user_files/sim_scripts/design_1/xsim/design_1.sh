...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/debug_interconnect.protoinst" -protoinst "protoinst_files/PL_NN_prototype.protoinst" -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/design_2.protoinst" -log simulate.log
}
