...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/projects/Test_DSP/Test_DSP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DSP_overpack_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DSP_overpack_wrapper.tcl -notrace
