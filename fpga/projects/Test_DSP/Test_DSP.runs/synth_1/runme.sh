...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/projects/Test_DSP/Test_DSP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DSP_overpack_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DSP_overpack_wrapper.tcl
