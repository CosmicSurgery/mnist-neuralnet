...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/projects/10_22/10_22.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PL_NN_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PL_NN_wrapper.tcl -notrace
