...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib blk_mem_gen_v8_4_4 axi_bram_ctrl_v4_1_2 xbip_utils_v3_0_10 xbip_pipe_v3_0_6 xbip_bram18k_v3_0_6 mult_gen_v12_0_16)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb PL_NN_sim.wdb xsim.dir)
