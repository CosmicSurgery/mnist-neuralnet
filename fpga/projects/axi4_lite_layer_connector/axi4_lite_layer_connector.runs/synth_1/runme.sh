...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/projects/axi4_lite_layer_connector/axi4_lite_layer_connector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi4_lite_layer_connector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi4_lite_layer_connector.tcl
