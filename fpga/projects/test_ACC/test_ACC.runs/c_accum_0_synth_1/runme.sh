...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/projects/test_ACC/test_ACC.runs/c_accum_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_accum_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_accum_0.tcl
