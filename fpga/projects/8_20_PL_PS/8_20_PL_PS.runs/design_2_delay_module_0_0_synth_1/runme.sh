...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/projects/8_20_PL_PS/8_20_PL_PS.runs/design_2_delay_module_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_delay_module_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_delay_module_0_0.tcl
