...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/8_20_PL_PS/8_20_PL_PS.runs/design_1_axi_bram_ctrl_0_bram_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_bram_ctrl_0_bram_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_bram_ctrl_0_bram_2.tcl
