...
HD_PWD='C:/git_repos/mnist_neuralnet/fpga/projects/perceptron/perceptron.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log perceptron.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source perceptron.tcl -notrace
